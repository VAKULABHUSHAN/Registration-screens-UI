...
import '5workout_preference_screen.dart';
...
class _MealTypeScreenState extends State<MealTypeScreen>
  ...
  final List<Map<String, dynamic>> goals = [
    {
      "title": "Vegetarian",
      "icon": Icons.eco, // plant-based icon
    },
    {
      "title": "Non - Vegetarian",
      "icon": Icons.set_meal, // meat/food icon
    },
    {
      "title": "Vegan",
      "icon": Icons.spa, // natural/leafy lifestyle
    },
    {
      "title": "Eggetarian",
      "icon": Icons.egg, // egg icon (Material 3)
    },
  ];
